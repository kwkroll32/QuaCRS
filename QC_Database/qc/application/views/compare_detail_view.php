...
EOF;
        ...
        <div class="header">
            <p style='float:right' title="Download Compare Result's"><span class='fa fa-download'></span></p>
            <p style='float:left;cursor: pointer'>Comparison Results</p>
        </div>
        <div class="tabBarToggle" id="togglebar">
            <div class="toggleButton"  onClick="toggleDataView(this)" data-toggle = "1" style="color:#0CF; border-color:#0CF">
                <p>Table Data</p>
            </div>
            ...
            <div class="infoContainer showContent" id="infoContainerOne">
                <div class="menu" id="menu">
                    <div class="viewTables">
                        <div class="topBanner"><p>Jump straight to a table</p></div>
                            <div class="linkHold">
                ...
                <div class='fastqcContainer' id="FastQCMoveHere">
                    <div class='topBanner'>
                        <button class="viewNameButtonTable" data-toggle = "close" target = "fastqcData" onclick="collapseViewIndividual(this);">Collapse Table</button>
                                        ...
                                        // Will now print the table data in accordance to group
                                                ...
                                                */
                                                ...
                                                foreach ($aggregate_result_views_cumulative[$viewName] as $key => $value) {
                                                    ...
                                                    //$collapseGraphRowToggle = ($keepRowOpen? 'data-toggle= "close"' : 'data-toggle= "open"');
						    $key_exploded = explode('_', $key,2);
                                                    $metric = str_replace( "%","", str_replace(">","",$key_exploded[1]));
                                                    ...
                                                    */
                                                    ...
                                                    if (!$keyPrinted){
                                                        ...
                                                        echo '<div '.$vanishStyleRow.'><div class= "tableRow border-bottom-light">'
                                                            .'<div class="tableColumn design-font" metric-small onClick="expandInt(this)" target="'.$indentifyMetric.'" '.$collapse.' >'.$carrier[0]."</div>";
                                                        $keyPrinted = true;
                                                    }
                                                    ...
                                                    echo "<div class='tableColumnWrap' id='$indentifyMetric' ".$collapse.">";
                                                        ...
                                                        for($i = 0; $i< $groupcount; $i++){
                                                            ...
                                                            echo "<div class='tableRow'>";
                                                                echo "<div class='tableColumn' metric-small>";
                                                                    echo "$groupname";
                                                                echo "</div>";
                                                                echo "<div class='tableColumn'>";
                                                        ...
                                                        if(!$vanishRow){
                                                            ...
                                                            /*echo "<div class='graphingHeader design-font' onClick = 'openGraphRow(this)' data-view='$indentifyMetric' $collapseGraphRowToggle>";
                                                                echo "<p>Graph</p>";
                                                            echo "</div>";*/
                                                            if($indentifyMetric == "End_1_%_Sense" || $indentifyMetric == "End_2_%_Sense"){
                                                                $indentifyMetric = str_replace("%", "_", $indentifyMetric);        
                                                            }
...
EOF;
    ...
    echo "</style>";
    echo "<div class='backdrop' id='backdrop'><div class='head'><p id='backDropTitle'></p><button class='btn btn-primary' onclick='closeDrop(); return false;'>Close</button></div><div class='backdropContent' id='backdropContent'></div></div>";
?>